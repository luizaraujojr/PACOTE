...
pdf(paste("C:/Users/luizantoniolao/Documents/GitHub/PACOTE/ils-clustering-main-experiment/data/experiment/result/boxplot-software-ref-4metricas.pdf", sep = ""), width=8,height=4)
...
pdf(paste("C:/Users/luizantoniolao/Documents/GitHub/PACOTE/ils-clustering-main-experiment/data/experiment/result/histograma-coeficientes-4metricas.pdf", sep = ""), width=8,height=4)
...
hist(as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", data1$solutionreal)), ",", simplify= TRUE)[,4]), xlab="Coeficiente A4", main="", ylab="Frequência", breaks=11, xlim=c(-2.5,+2.5), ylim=c(0,10))


hist(as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", data1$solutionreal)), ",", simplify= TRUE)[,5]), xlab="Coeficiente B1", main="", ylab="Frequência", breaks=11, xlim=c(-2.5,+2.5), ylim=c(0,10))
hist(as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", data1$solutionreal)), ",", simplify= TRUE)[,6]), xlab="Coeficiente B2", main="", ylab="Frequência", breaks=11, xlim=c(-2.5,+2.5), ylim=c(0,10))
hist(as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", data1$solutionreal)), ",", simplify= TRUE)[,7]), xlab="Coeficiente B3", main="", ylab="Frequência", breaks=11, xlim=c(-2.5,+2.5), ylim=c(0,10))
hist(as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", data1$solutionreal)), ",", simplify= TRUE)[,8]), xlab="Coeficiente B4", main="", ylab="Frequência", breaks=11, xlim=c(-2.5,+2.5), ylim=c(0,10))
...
pdf(paste("C:/Users/luizantoniolao/Documents/GitHub/PACOTE/ils-clustering-main-experiment/data/experiment/result/boxplot-coeficientes-4metricas.pdf", sep = ""), width=8,height=4)
...
geom_boxplot()   + ylim(-2.5,+2.5)+ xlab("Coeficiente A4") + ylab("")
...
p7 <- ggplot(data1, aes(x=software, y=as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", solutionreal)), ",", simplify= TRUE)[,7]))) +
geom_boxplot()   + ylim(-2.5,+2.5)+ xlab("Coeficiente B3") + ylab("")

p8 <- ggplot(data1, aes(x=software, y=as.numeric(str_split(gsub("[[]", "", gsub("[,]]", "", solutionreal)), ",", simplify= TRUE)[,8]))) +
geom_boxplot()   + ylim(-2.5,+2.5)+ xlab("Coeficiente B4") + ylab("")
