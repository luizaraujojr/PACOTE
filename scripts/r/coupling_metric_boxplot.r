...
pdf(paste("D:/Backup/eclipse-workspace/pacote/results/", project, "_CBO.pdf", sep = ""), width=8,height=3)
par(mar=c(4,3,3,3))
boxplot(data$cbo~data$versions, main="CBO", xlab='', ylab='', las =2);
dev.off();

pdf(paste("D:/Backup/eclipse-workspace/pacote/results/", project, "_AFF.pdf", sep = ""), width=8,height=3)
par(mar=c(4,3,3,3))
boxplot(data$aff~data$versions, main="Afferent Coupling", xlab='', ylab='', las =2);
dev.off();

pdf(paste("D:/Backup/eclipse-workspace/pacote/results/", project, "_EFF.pdf", sep = ""), width=8,height=3)
par(mar=c(4,3,3,3))
boxplot(data$eff~data$versions, main="Efferent Coupling", xlab='', ylab='', las =2);
dev.off();

pdf(paste("D:/Backup/eclipse-workspace/pacote/results/", project, "_LCOM.pdf", sep = ""), width=8,height=3)
par(mar=c(4,3,3,3))
boxplot(data$lcom~data$versions, main="LCOM", xlab='', ylab='', las =2);
dev.off();

pdf(paste("D:/Backup/eclipse-workspace/pacote/results/", project, "_MF.pdf", sep = ""), width=8,height=3)
par(mar=c(4,3,3,3))
boxplot(data$mf~data$versions, main="Modularization Factor", xlab='', ylab='', las =2);
dev.off();

pdf(paste("D:/Backup/eclipse-workspace/pacote/results/", project, "_CS.pdf", sep = ""), width=8,height=3)
par(mar=c(4,4,3,3))
