		...
		public double calculateFitness()
		{
			...
			if (functionParams.length==4) {
				...
				for (int clusterNumber = 0; clusterNumber < totalClusteres; clusterNumber++) {
					double fa1 = (((double)functionParams[0]-5.0)/2.0 ) * internalDependencyWeight[convertToClusterNumber(clusterNumber)]; //N�mero de depend�ncias diretas entre classes 
					double fb1 = (((double)functionParams[2]-5.0)/2.0 ) * internalDependencyWeight[convertToClusterNumber(clusterNumber)]; //N�mero de depend�ncias diretas entre classes
					double fb2 = (((double)functionParams[3]-5.0)/2.0 ) * externalDependencyWeight[convertToClusterNumber(clusterNumber)]; //N�mero de depend�ncias entre classes de pacotes diferentes
				...
				int[] insidePackageDependencyClassCount = new int[mdg.getSize()]; // N�mero de classes com depend�ncias diretas dentro do pacote
				int[] outsidePackageDependencyClassCount = new int[mdg.getSize()];  //N�mero de classes do pacote sob an�lise com depend�ncias para classes de outro pacote
				
				int[] outsideInternalDependencyClassCount = new int[mdg.getSize()]; //N�mero de classes de outro pacote com depend�ncias para classes de um pacote sob an�lise
				...
				int[] insidePackageClassDependencyCount = new int[mdg.getSize()];   //N�mero de depend�ncias diretas entre classes
				int[] outsidePackageClassDependencyCount  = new int[mdg.getSize()];  //N�mero de depend�ncias entre classes de pacotes diferentes
				
				
				for (int clusterNumber = 0; clusterNumber < totalClusteres; clusterNumber++)
				{
					insidePackageClassDependencyCount[clusterNumber] = internalDependencyWeight[convertToClusterNumber(clusterNumber)]; //N�mero de depend�ncias diretas entre classes
					outsidePackageClassDependencyCount[clusterNumber]  = externalDependencyWeight[convertToClusterNumber(clusterNumber)]; //N�mero de depend�ncias entre classes de pacotes diferentes
