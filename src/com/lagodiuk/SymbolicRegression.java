...
//						new Target().when("x", 6).targetIs(96));
		...
		LNSEvolutionFitness fitness = new LNSEvolutionFitness (); 
		
		
//		// define training set
//		TabulatedFunctionFitness fitness =
//				new TabulatedFunctionFitness(
//						new Target().when("x", 2).targetIs(6),
//						new Target().when("y", 3).targetIs(6),
//						new Target().when("z", 3).targetIs(6));	
//
...
//						list(Functions.ADD , Functions.SUB , Functions.MUL));
//						list(Functions.ADD , Functions.SUB , Functions.MUL , Functions.DIV , Functions.SQRT , Functions.POW , Functions.LN , Functions.SIN, Functions.COS));
		
				list(Functions.ADD, Functions.SUB, Functions.MUL, Functions.DIV, Functions.SQRT , Functions.POW , Functions.LN , Functions.SIN, Functions.COS,  Functions.VARIABLE, Functions.CONSTANT));
