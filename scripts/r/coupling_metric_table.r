...
colnames <- c("CBO", "AFF", "EFF", "LCOM", "MQ", "MF", "CS");
...
write.csv(result,file="D:/Backup/eclipse-workspace/PACOTE/results/coupling_matric_table.csv")
...
write.csv(round(cor(result,  method = "spearman"),2),file="D:/Backup/eclipse-workspace/PACOTE/results/coupling_matric_spearman.csv")
