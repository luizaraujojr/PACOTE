	...
	write.csv(result,file=paste("D:/Backup/eclipse-workspace/PACOTE/result/table/", project, "_coupling_metric_table.csv", sep = ""))


	#cheking the correlation

	write.csv(round(cor(result,  method = "spearman"),2),file=paste("D:/Backup/eclipse-workspace/PACOTE/result/table/", project, "_coupling_metric_table_spearman.csv", sep = ""))
