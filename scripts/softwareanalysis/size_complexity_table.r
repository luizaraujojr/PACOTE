...
data <- read.table(paste(baseDirectory, "/PACOTE/data/SoftwareAnalysis/JARProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
...
data <- read.table(paste(baseDirectory, "/PACOTE/data/SoftwareAnalysis/ODEMProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
...
write.csv(result,file=paste(baseDirectory, "/PACOTE/result/table/", project, "_size_complexity.csv", sep = ""))

write.csv(round(cor(result,  method = "spearman"),2),   file=paste(baseDirectory, "/PACOTE/result/table/", project, "_size_complexity_spearman.csv", sep = ""))
