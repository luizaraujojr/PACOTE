	...
	project <-"JHotDraw"
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/data/graph/", project, "_classpackage.pdf", sep = ""), width=8,height=3)
	...
	project <-"JHotDraw"
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/data/graph/", project, "_classattribute.pdf", sep = ""), width=8,height=3)
	...
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/data/graph/", project, "_classmethod.pdf", sep = ""), width=8,height=3)
	data <- read.table(paste("D:/Backup/eclipse-workspace/PACOTE/results/JARProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
	...
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/data/graph/", project, "_classpublicmethod.pdf", sep = ""), width=8,height=3)
	data <- read.table(paste("D:/Backup/eclipse-workspace/PACOTE/results/JARProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
	#data = subset(data, data$versions %notin% JEdit_Exclude)
	par(mar=c(5,3,3,3), oma = c(0, 0, 0, 0), mai=c(.7,.5,.5,.1))
