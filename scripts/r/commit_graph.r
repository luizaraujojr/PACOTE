	...
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/data/graph/", project, "_AffectedClasses.pdf", sep = ""), width=8,height=5)
	...
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/data/graph/", project, "_AffectedPackages.pdf", sep = ""), width=8,height=5)
	data <- read.table(paste("D:/Backup/eclipse-workspace/PACOTE/results/", project, "_RevisionsByVersion.data", sep = ""), header=TRUE);
