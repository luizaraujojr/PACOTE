...
package br.com.ppgi.unirio.teaching.clustering.mojo;
...
public class MoJo {
    ...
    public static double MojoFM(String[] args) {
    	double resultMojo = 0;
        try
        {
            String sourceFile = null, targetFile = null, relFile = null;
