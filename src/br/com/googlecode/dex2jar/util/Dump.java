 ...
 */
package br.com.googlecode.dex2jar.util;
...
import br.com.googlecode.dex2jar.reader.DexFileReader;
...
import br.com.googlecode.dex2jar.visitors.EmptyVisitor;
...
public class Dump extends EmptyVisitor {
    ...
    public static void doFile(File srcDex) throws Exception {
        doFile(srcDex, new File(srcDex.getParentFile(), srcDex.getName() + "_dump.jar"));
    }

    public static void doFile(File srcDex, File destJar) throws IOException, Exception {
