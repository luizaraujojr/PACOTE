...
public class ClusterMetricsFull
{
...
//	private int[] externalInternalPackageDep;
	 ...
	 */
	public ClusterMetricsFull(ModuleDependencyGraph mdg, int[] solution, int[] equationParams, Project project, boolean[] usedMetrics)
	{
		this.mdg = mdg;
