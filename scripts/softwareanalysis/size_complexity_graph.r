	...
	project <-"JHotDraw"
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/result/images/", project, "_classpackage.pdf", sep = ""), width=8,height=3)
	data_classespackages <- read.table(paste("D:/Backup/eclipse-workspace/PACOTE/data/SoftwareAnalysis/JARProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
	...
	project <-"JHotDraw"
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/result/images/", project, "_classattribute.pdf", sep = ""), width=8,height=3)
	...
	#data1 = data[data$versions %notin% JEdit_Exclude,]
	...
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/result/images/graph/", project, "_classmethod.pdf", sep = ""), width=8,height=3)
	data <- read.table(paste("D:/Backup/eclipse-workspace/PACOTE/data/SoftwareAnalysis/JARProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
	...
	pdf(paste("D:/Backup/eclipse-workspace/PACOTE/result/images/graph/", project, "_classpublicmethod.pdf", sep = ""), width=8,height=3)
	data <- read.table(paste("D:/Backup/eclipse-workspace/PACOTE/data/SoftwareAnalysis/JARProjectCharacteristics", project, ".data", sep = ""), header=TRUE);
	#data = subset(data, data$versions %notin% JEdit_Exclude)
	par(mar=c(5,3,3,3), oma = c(0, 0, 0, 0), mai=c(.7,.5,.5,.1))
